...
base_url = "https://cs.tongji.edu.cn/"  # 必须包含协议和域名
...
def parse_list_page(content, path='//*[@id="line_u8_0"]'):
    path += '/tr/a[@href and @title]'
...
if __name__ == "__main__":
    ...
    pro="https://www.cs.sdu.edu.cn/szdw1/js.htm"
    fjs="https://www.cs.sdu.edu.cn/szdw1/fjs.htm"
    yjy="https://www.cs.sdu.edu.cn/szdw1/yjy.htm"
    zljs="https://www.cs.sdu.edu.cn/szdw1/zljs.htm"
    list = [pro,fjs,yjy,zljs]
